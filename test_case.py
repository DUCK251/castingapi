...
MOVIES = [
    ...
    [
        ...
        ('As homicide detective Thomas Craven investigates'
    ...
    [
        'Fish Tank', '2021-08-10', 'ABC Productions',
    ...
    [
        "The Last Temptation of Christ", "2023-10-01", "Jadran Film",
    ...
    [
        "Palace Beach Hotel", "2023-01-01", "Jadran Film",
    ...
    [
        "Nordwand", "2021-03-28", "Jadran Film",
    ...
    [
        "Das Zeugenhaus", "2020-12-20", "Jadran Film",
    ...
    [
        "Hannah Arendt", "2021-04-12", "Met film",
        ("A look at the life of philosopher and political "
         "theorist Hannah Arendt, who reported for 'The New "
         "Yorker' on the trial of the Nazi leader Adolf "
         "Eichmann in Jerusalem.")
    ],
    [
        "Die Wand", "2021-04-13", "Met film",
    ...
    [
        ...
        ("When violent conflict breaks out between greedy railroaders"
         ...
         " Winnetou and German engineer Old Shatterhand.")
    ],
    [
    ...
    [
        "Mein Gott, Anna!", "2024-06-06", "Netflix",
        "Anna life stroy"
    ],
    [
        "Momentversagen", "2024-07-17", "Netflix",
        ("In a trendy restaurant, public prosecutor Manuel Bacher"
